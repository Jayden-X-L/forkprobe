...
For v0.1 we use the official Python SDKs to call those APIs directly. This
...
def spawn_subagent(
    ...
    if platform == Platform.CLAUDE_CODE:
        ...
        return SubagentResult(
            ...
            tokens_used=0,
            latency_seconds=0.0,
            error=f"Unknown platform: {platform}. forkprobe v0.1 supports Claude Code and Codex only.",
        )
